        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    //Vector3 jitterOffset = new Vector3(RandomPercentage.Range(-.25f, .25f), RandomPercentage.Range(-.25f, .25f), 0);
                    ...
                    //matrix = Matrix4x4.TRS(jitterOffset, Quaternion.Euler(0, 0, RandomPercentage.Range(-5f, 5f)), Vector3.one * randomScale);
